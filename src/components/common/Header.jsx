      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <div className="text-xl font-bold text-gray-900">Sankalp School</div>
              <div className="text-xs text-gray-600">Special Needs Education</div>
            </div>
          </Link>
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={`px-3 py-2 text-sm font-medium transition-colors duration-200 ${
                    isActive(item.href)
                      ? 'text-blue-600 bg-blue-50 px-4 rounded-lg'
                      : 'text-gray-700 hover:text-blue-600'
                  }`}
                >
                  {item.name}
