    ...
    <div className="relative w-full h-64 rounded-lg overflow-hidden">
      ...
      <div className="w-full h-full bg-gradient-to-br from-blue-100 to-orange-100 flex items-center justify-center">
        <div className="text-center text-gray-600">
          ...
          <p className="font-medium">{title}</p>
          <p className="text-sm text-gray-500">Image {currentImage + 1} of {images.length}</p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 text-lg max-w-3xl mx-auto mt-4">{data.events.description}</p>
          </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="heading-secondary">{data.vocationalTraining.title}</h2>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto mt-4">{data.vocationalTraining.description}</p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-700 text-lg max-w-3xl mx-auto mt-4">{data.achievements.description}</p>
          </div>
      ...
      <section className="section-padding bg-blue-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Discover how your child can participate in our events and vocational training programs.
          </p>
