    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-orange-500 text-white py-20">
        <div className="container-custom text-center">
          ...
          {data.description && (
            <p className="text-lg max-w-4xl mx-auto text-blue-100 leading-relaxed">{data.description}</p>
          )}
        </div>
      </section>
              ...
              <div key={index} className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                ...
                <div className="w-full h-48 bg-gradient-to-br from-blue-100 to-orange-100 flex items-center justify-center">
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-sm text-gray-500">Program Image</p>
                  </div>
                </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-secondary mb-8">Individualized Educational Plans (IEP)</h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-12">
              Each child's educational journey at Sankalp is guided by a comprehensive Individualized Educational Plan (IEP) 
              created collaboratively by our team of teachers, specialists, and families. This ensures that every child receives 
              education tailored to their unique needs and abilities.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6 text-center shadow-md">
                ...
                <p className="text-gray-600 text-sm">Comprehensive evaluation of each child's needs and abilities</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-md">
                ...
                <p className="text-gray-600 text-sm">Collaborative development of individualized learning goals</p>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 text-center shadow-md">
                ...
                <p className="text-gray-600 text-sm">Execution of specialized programs and continuous monitoring</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-blue-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Learn more about how our specialized curriculum can benefit your child's development and growth.
          </p>
