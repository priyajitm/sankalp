    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <h2 className="heading-secondary text-center mb-12">{data.admissionInfo.title}</h2>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-orange-50 rounded-xl p-8">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">{data.schoolTimings.title}</h3>
              <div className="space-y-6">
                {data.schoolTimings.schedule.map((timing, index) => (
                  <div key={index} className="border-b border-orange-200 pb-4 last:border-b-0 last:pb-0">
                    <div className="flex justify-between items-start mb-2">
                      <span className="font-semibold text-gray-900">{timing.level}</span>
                      <span className="text-orange-600 font-bold">{timing.time}</span>
                    </div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-lg max-w-3xl mx-auto mt-4">{data.facilities.description}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {data.facilities.items.map((facility, index) => (
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="aspect-w-16 aspect-h-9 bg-gradient-to-br from-blue-100 to-orange-100">
      ...
      <section className="section-padding bg-blue-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Contact us today to learn more about our admission process and schedule a visit to our facilities.
          </p>
